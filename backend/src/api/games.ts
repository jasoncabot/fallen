...
// import { findAllByUser } from '../service/game';
// import { Request, Response, NextFunction } from "express";

import { findAllByUser } from "src/service/game";
import { Middleware } from "../index.interface";
import { requireUser } from "./auth";

// import { requireUser } from "./auth";
// import { findByIdAndUser } from "../service/game";

const register = (middleware: Middleware) => {

    const { express, redis } = middleware;

    // // GET /games/:id
    // // Read game
    // express.get('/games/:id', requireUser, (req, res) => {
    ...
    express.get('/games', requireUser, (req: Request, res: Response) => {
