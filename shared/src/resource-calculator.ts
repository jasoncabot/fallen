...
class ResourceCalculator {
    ...
    calculateIncome = (province, category) => {
        // TODO: need to take the current technology 
        return Object.values(province.structures || {}).reduce((total, structure: any) => {
    ...
    countUnitsOutside = (province) => {
        return Object.values(province.units || {}).length;
    }
}


export { ResourceCalculator };